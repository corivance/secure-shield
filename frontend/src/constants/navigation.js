...
export const NAV_ITEMS = [
  ...
  { to: '/audit', key: 'nav.audit', label: 'Audit Trail', icon: 'bar-chart' },
  ...
  { to: '/compliance', key: 'nav.compliance', label: 'Compliance', icon: 'clipboard' },
  { to: '/plans', key: 'nav.plans', label: 'Plans', icon: 'credit-card' },
  { to: '/how-it-works', key: 'nav.how', label: 'How It Works', icon: 'info' },
  { to: '/getting-started', key: 'nav.gettingStarted', label: 'Getting Started', icon: 'compass' },
...
export const ADMIN_NAV_ITEMS = [
  ...
  { to: '/admin/plans', key: 'adminNav.plans', label: 'Plans', icon: 'credit-card' },
